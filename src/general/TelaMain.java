...
public class TelaMain extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(nome1)
                    .addComponent(nome3, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE))
                .addGap(142, 142, 142)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel5)
                    .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(nome4, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
    ...
    private void btnJogarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJogarActionPerformed
        ...
        if(!(nome1.getText().isEmpty())){
            Jogador jog = new Jogador(nome1.getText());
            jogo.setJogador(jog);
        }if(!(nome2.getText().isEmpty())){
            Jogador jog = new Jogador(nome2.getText());
            jogo.setJogador(jog);
        }if(!(nome3.getText().isEmpty())){
            Jogador jog = new Jogador(nome3.getText());
            jogo.setJogador(jog);
        }if(!(nome4.getText().isEmpty())){
            Jogador jog = new Jogador(nome4.getText());
            jogo.setJogador(jog);
        }
        if(jogo.getJogadores().size() > 1){
            ...
            JOptionPane.showMessageDialog(null, "É necessario mais de um jogador!");
        }
